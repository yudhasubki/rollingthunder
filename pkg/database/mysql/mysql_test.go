...
func TestMySQLLiveConformance(t *testing.T) {
	...
	config := Config{
		...
		SSLRootCert: os.Getenv("ROLLINGTHUNDER_MYSQL_TEST_SSL_ROOT_CERT"),
		SSLCert:     os.Getenv("ROLLINGTHUNDER_MYSQL_TEST_SSL_CERT"),
		SSLKey:      os.Getenv("ROLLINGTHUNDER_MYSQL_TEST_SSL_KEY"),
